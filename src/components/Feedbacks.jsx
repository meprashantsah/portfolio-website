    ...
    <div className='mt-12 bg-black-100 rounded-[20px] '>
      <div className='sm:px-16 px-6 sm:py-16 py-10 bg-tertiary rounded-2xl min-h-[300px]'>
        <motion.div variants={textVariant()}>
          <p className='sm:text-[18px] text-[14px] text-secondary uppercase tracking-wider'>WHAT OTHERS BELIEVE?</p>
          <h2 className='text-white font-black md:text-[60px] sm:text-[50px] xs:text-[40px] text-[30px]'>EXCERPTS.</h2>
        </motion.div>
      </div>
